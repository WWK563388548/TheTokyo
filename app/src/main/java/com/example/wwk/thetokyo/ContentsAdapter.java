...
public class ContentsAdapter extends ArrayAdapter<Contents> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.textTainer = (LinearLayout) listItemView.findViewById(R.id.text_container);
            viewHolder.spotImage = (ImageView) listItemView.findViewById(R.id.image_view);
            viewHolder.spotName = (TextView) listItemView.findViewById(R.id.spotname_text_view);
            viewHolder.spotAddress = (TextView) listItemView.findViewById(R.id.spotaddress_text_view);
        ...
        viewHolder.textTainer.setBackgroundColor(color);
        viewHolder.spotImage.setImageResource(currentCotents.getmImageResourceId());
        viewHolder.spotName.setText(currentCotents.getmSpotsName());
        viewHolder.spotAddress.setText(currentCotents.getmSpotsAddress());
